        ...
        <div className="bg-black min-h-screen text-white font-sans selection:bg-[#61FFB1] selection:text-black">
            ...
            <div className="relative z-10">
                ...
                <div className="pt-24 pb-2 container mx-auto px-6" ref={addToRefs}>
                    <h2 className="title-with-lines mb-16 text-center">Transformation Across the Care Journey</h2>
                    <JourneyCards
                        steps={[
                            { id: 1, stage: "Pre-Visit", items: "Online discovery, appointment booking, digital onboarding, eligibility checks." },
                            { id: 2, stage: "During Visit", items: "Digital forms, integrated EHR, clinical decision support, e-prescriptions." },
                            { id: 3, stage: "Post-Visit", items: "Follow-up reminders, remote monitoring, teleconsultations, digital billing." },
                            { id: 4, stage: "Operations", items: "Real-time dashboards for occupancy, revenue, quality metrics, and patient satisfaction." }
                        ]}
                    />
                </div>
